...
cppcheck -i_deps --suppress='*:_deps/*' --enable=all --suppress=missingInclude --suppress=missingIncludeSystem --suppress=useStlAlgorithm --suppress=duplInheritedMember --project=compile_commands.json
```
